...
#for i in range(10): 
    if child_a[i]['class'][-1] == expresiones[0]:
        ...
        archivorRed = open("C:\\Users\\10042891\\.spyder-py3\\DatosRed\\circuito"+str(numLink)+".txt","r")
...
df.to_excel("C:\\Users\\10042891\\.spyder-py3\\DataD.xlsx", sheet_name="DataD", index=False)