...
Original file is located at
    https://colab.research.google.com/drive/1D3c_MFbGWHWKYKA4qoLefRunPFhuz-yq
"""
...
#with open("C:/Users/10042891/.spyder-py3/circuito.txt", "w") as archivo:
#    archivo.write(pagina.text)
#pagina.text

#osoup = BeautifulSoup(pagina.text, 'html.parser')

archivo = open("C:\\Users\\10042891\\.spyder-py3\\circuito.txt","r")
pagina = archivo.read()
archivo.close()
    ...
    if child_a[i]['class'][-1] == expresiones[0]:
        ...
        for link in child_links:
            if link.has_attr('href'):
               ...
               #with open("C:/Users/10042891/.spyder-py3/DatosRed/circuito"+str(recorrerRed)+".txt", "w") as dataRed:
...
df.to_excel("C:\\Users\\10042891\\.spyder-py3\\DataDP.xlsx", sheet_name="DataDP", index=False)
